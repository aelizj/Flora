const plantData = [
  {
    ...
    description: 'Not actually a member of the philodendron family, the Monstera deliciosa, also known as the Swiss cheese plant, is a popular houseplant native to the tropical rainforests of Central and South America. It is loved for its unique, large, glossy leaves with natural holes, or fenestrations.'
  },
  {
    commonName: 'Brasil philodendron',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1589999251554-21789097351f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=696&q=80',
    description: 'Pilea peperomioides, the Chinese money plant, UFO plant, pancake plant, lefse plant or missionary plant, is a species of flowering plant in the nettle family Urticaceae, native to Yunnan and Sichuan provinces in southern China. Commonly confused as a member of the Peperomia family.'
  },
  {
    commonName: 'Zebra Haworthia',
    scientificName: 'Haworthiopsis attenuata',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/76/Ab_plant_846.jpg',
